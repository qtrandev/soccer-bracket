...
function winnerSvg(championName, flagDataUri) {
  ...
  <text x="600" y="575" font-family="DejaVu Sans,sans-serif" font-size="${nameFontSize}" font-weight="700" fill="white" text-anchor="middle">${escapeXml(championName)}</text>
  ${trophySvg(600, 770, 0.70)}
  <text x="600" y="980" font-family="DejaVu Sans,sans-serif" font-size="38" font-weight="700" fill="#22c55e" text-anchor="middle">World Cup Champion · 2026</text>
  <text x="600" y="1042" font-family="DejaVu Sans,sans-serif" font-size="30" font-weight="400" fill="#22c55e" fill-opacity="0.7" text-anchor="middle">Make your own bracket at bracketwebb.com</text>
  <text x="600" y="1095" font-family="DejaVu Sans,sans-serif" font-size="26" font-weight="400" fill="#22c55e" fill-opacity="0.4" text-anchor="middle">bracketwebb.com</text>
</svg>`;
}
...
function genericSvg() {
  ...
  <text x="600" y="1075" font-family="DejaVu Sans,sans-serif" font-size="48" font-weight="700" fill="white" text-anchor="middle">2026 FIFA World Cup</text>
  <text x="600" y="1150" font-family="DejaVu Sans,sans-serif" font-size="30" font-weight="400" fill="#22c55e" fill-opacity="0.6" text-anchor="middle">bracketwebb.com</text>
</svg>`;
}
